...
module EAB1 where
        ...
        --Al introducir el comando "eval gt" en la terminal obtenemos el resultado deseado 35 > 30 -> B True.
        ...
        --Al introducir el comando "eval lt" en la terminal obtenemos el resultado deseado 35 < 30 -> B False.
